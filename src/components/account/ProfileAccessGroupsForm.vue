    ...
    <div class="col">
      ...
      <div class="card border">
        ...
        <div class="card-body">
          ...
          <el-form ref="restrictedFormRef" :model="user" label-width="120px" label-position="top" class="card-body"
            status-icon :disabled="!admin">

            <el-row :gutter="20">
              <el-col :span="6">
                <el-form-item label="Status" prop="status">
                  <el-select :disabled="!admin" v-model="user.status" placeholder="Status">
              ...
              <el-col :span="6">
                <el-form-item label="User Profile" prop="type">
                  <el-select :disabled="!admin" v-model="user.type" class="" placeholder="Type">
                    <el-option v-for="item1 in typeOptions" :key="item1.value" :label="item1.label"
                      :value="item1.label" />
                  </el-select>
                </el-form-item>
              </el-col>
            ...
            <el-row v-if="admin && isAdmin" :gutter="20" class="mt-2 mb-2 w-100">
              <el-transfer class="user-groups" filterable :filter-method="filterMethod"
                :titles="['Unassigned Groups', 'Assigned Groups']" :props="{
                  key: 'id',
                  label: 'name'
                }" :data="lov" v-model="formGroups" />
            </el-row>


            <div v-if="admin && isAdmin" class="pt-2 d-sm-flex justify-content-end">
              <el-form-item>
